...
setup(
    ...
    version='1.0.0',
    description='A pure Python 2/3 library for peripheral I/O (GPIO, LED, SPI, I2C, MMIO, Serial) in Linux.',
    author='vsergeev',
    ...
    license='MIT',
    keywords='gpio spi led i2c mmio serial uart embedded linux beaglebone raspberrypi rpi',
    )
