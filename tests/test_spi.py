...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("")
        print("Hint: for BeagleBone Black, disable the HDMI cape with:")
        print("    capemgr.disable_partno=BB-BONELT-HDMI,BB-BONELT-HDMIN")
        print("to optargs in uEnv.txt, reboot, and export SPI1 to /dev/spidev1.* with:")
        print("    echo BB-SPIDEV1 > /sys/devices/bone_capemgr.9/slots")
        print("to enable SPI1 (CS=P9.28, MOSI=P9.29, MISO=P9.30, CLK=P9.31).")
        print("Connect a wire between MOSI and MISO, then run this test:")
